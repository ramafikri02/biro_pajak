...
<div class="row">
    <div class="col-lg-12">
        <div class="box">
            <form action="{{ route('wilayah.update') }}" class="form-penjualan" method="post">
                @csrf
                <div class="box-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-2">
                            <input type="text" name="nama_wilayah" class="form-control" id="nama_wilayah" value="{{ $data_wilayah->nama_wilayah }}" required autofocus>
